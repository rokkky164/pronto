...
from pronto.settings import URL_PREFIX
...
from utils.interactors import get_record_by_filters, get_record_by_id, db_create_record, db_update_instance, \
    db_update_records_with_filters
from utils.tasks import base_task
from accounts.settings import RESEND_NOTIFICATION_EMAIL_TIME, DELETE_ACCOUNT_REQUEST_HOURS
