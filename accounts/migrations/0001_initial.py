    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_hubs', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=50), blank=True, default=list, size=None)),
                ...
                ('vat_payer', models.CharField(blank=True, max_length=100, null=True, verbose_name='Vat Payer')),
