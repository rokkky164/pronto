# Generated by Django 4.0.7 on 2024-07-23 03:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('S', 'Saved'), ('AR', 'Approval Requested'), ('A', 'Approved'), ('R', 'Rejected')], max_length=50, verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Account Manager Name')),
                ('title', models.CharField(max_length=100, verbose_name='Title')),
                ('department', models.CharField(max_length=100, verbose_name='Department')),
                ('email', models.EmailField(max_length=100, unique=True, verbose_name='Email')),
                ('phone', models.CharField(blank=True, max_length=14, null=True, verbose_name='Mobile Number')),
