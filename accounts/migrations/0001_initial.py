    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, related_name='associated_users', to='authorization.permission', verbose_name='Permissions')),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='authorization.role', verbose_name='Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.company')),
